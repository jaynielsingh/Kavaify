          ...
          >
            <div class="col-lg-6 mx-auto">
              <h3 class="text-white fs-5 mb-4">
                Kavaify is here to help Small Businesses with their web needs,
                from building your website to custom web applications without
                you having to worry. A professional Business like yours needs a
